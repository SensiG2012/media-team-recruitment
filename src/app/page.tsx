...
export default function Home() {
  return (
    <main className="app-shell flex min-h-screen flex-col items-center justify-center px-4 py-10 text-white">
      ...
      <footer className="mt-6 text-center text-[8px] text-white/18">Developed by Sensith Gunasekara 10E
</footer>
    </main>    
  );
}